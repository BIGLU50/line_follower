...
class Follower:
    ...
    # Compute the "centroid" and display a red circle to denote it
        ...
        if M['m00'] > 0:
            cx = int(M['m10']/M['m00']) + 0 #THE + IS THE DISPLACEMENT VALUE OF THE CENTROID; ADJUST THIS FROM -100 (left of the line) to 0 (directly on top of the line ) to 100 (right of the line)
            cy = int(M['m01']/M['m00'])
